...
$numero = $_GET["numero"];
$consulta = "SELECT * FROM tvx_form_rehabicentro form INNER JOIN tvx_users u ON u.ID=form.paciente WHERE form.identidad='$numero'";
...
if(!empty($_SESSION)){
	...
	$twig->display('rehabicentro_print.html',array(
		"resultado" => $resultado,
		"lista" => True,
	));
}
