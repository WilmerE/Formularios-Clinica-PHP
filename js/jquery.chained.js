...
;(function($, window, document, undefined) {
    ...
    $.fn.chained = function(parentSelector) {
        return this.each(function() {
            ...
            /* Guarde esto para el child porque esto cambia cuando cambia el alcance. */
            var child   = this;
            var backup = $(child).clone();

            /* Handles maximum two parents now. */
            /* Maneja un máximo de dos parents ahora. */
            $(parentSelector).each(function() {
                ...
                /* Obligar a IE a ver algo seleccionado en la carga de la primera página, */
                /* a menos que algo ya esté seleccionado */
                if (!$("option:selected", this).length) {
                    $("option", this).first().attr("selected", "selected");
                }

                /* Force updating the children. */
                /* Fuerza de actualización de los child. */
                updateChildren();
            });
            ...
            function updateChildren() {
                ...
                /* Si varios padres crean valor como foo+bar. */
                var selected = "";
                $(parentSelector).each(function() {
                ...
                /*       without subclassing. */
                /* También verifique el primer padre sin subclases. */
                /* TODO: Esto debe ser dinámico y verificar para cada padre */
                /* sin subclases. */
                var first;
