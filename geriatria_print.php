...
$numero = $_GET["numero"];
$consulta = "SELECT * FROM tvx_form_geriatria form INNER JOIN tvx_users u ON u.ID=form.paciente WHERE form.numero='$numero'";
...
if(!empty($_SESSION)){
	...
	$twig->display('geriatria_print.html',array(
		"resultado" => $resultado,
		"lista" => True,
	));
}
